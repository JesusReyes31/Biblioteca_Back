...
import { getGenres,getBooksByGenre, search, nodemail, resetpassword, prinAdminSuc, prinAdmin, credencial, reportes, verify_token } from "../controllers/others.controller";
const router = Router();
